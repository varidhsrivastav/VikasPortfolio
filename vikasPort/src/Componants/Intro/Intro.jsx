          ...
          <div className="text-center">
            ...
            <div className="flex justify-center py-3">
              <p className="text-xl sm:w-[70%] font-medium color-black">
                Don&apos;t miss out on this opportunity to enhance your intraday trading skills and achieve your financial goals. Join our Premium telegram group and start your profitable trading journey.
              </p>
            </div>
          </div>
          <div>
