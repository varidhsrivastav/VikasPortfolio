...
const WhatsappRev = () => {
  return (
    ...
    <img src={wawe} alt="" className='absolute w-[100%] top-[0%] -z-10 opacity-10 h-[100%]'/>
      <div className='container'>
        <div className='flex md:flex-row flex-col'>
          <div className='flex-1 flex justify-center  flex-col'>
            <p className='text-3xl sm:text-6xl pb-3 sm:pb-5 font-bold justify-center md:justify-start md:!text-left text-center text-[#495057]'>Get the <span className='text-[#2FCE86]'> Inside Scoop</span>  from Our Traders</p>
          </div>
